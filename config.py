...
CUSTOMER_PROBLEMS_SOLUTIONS = {
    "order tracking": "You can track your order by providing your Order ID. Please share your Order ID if you need further assistance.",
    ...
    "cancel order": "You can cancel your order within a few minutes of placing it. If the restaurant has already started preparing, cancellation might not be possible, or a cancellation fee may apply.",
    ...
    "app not working": "Please ensure you have a stable internet connection and try restarting the chatbot. If the problem persists, please contact us directly.",
    ...
    "restaurant feedback": "We appreciate your feedback! You can share your review for the restaurant and specific food items here. This helps us improve our service.",
